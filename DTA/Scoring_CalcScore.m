...
function [score minStart maxStart] = Scoring_CalcScore(DTA_Params,agent,taskCurr,taskPrev,timePrev,taskNext,timeNext)
    
if((agent.type == DTA_Params.AGENT_TYPES.QUAD) || ...
   (agent.type == DTA_Params.AGENT_TYPES.CAR)||...
   (agent.type == DTA_Params.AGENT_TYPES.BB)||...
   (agent.type == DTA_Params.AGENT_TYPES.CC)||...
   (agent.type == DTA_Params.AGENT_TYPES.DD))
