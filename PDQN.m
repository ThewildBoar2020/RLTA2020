function []=PDQN()
   ...
   % for e=109:E
    ...
    plot(144 ,427,'c*','markersize',8);text(144,447,'中段初始点','FontSize',14,'color','r','FontName','Microsoft YaHei')
    plot(658,301,'c*','markersize',8);text(658,321,'再入点','FontSize',14,'color','r','FontName','Microsoft YaHei')
    text(290,290,'(拦截器区域)','FontSize',14,'color','r','FontName','Microsoft YaHei')
    legend('飞行器运动轨迹');
    title('飞行器的轨迹');
