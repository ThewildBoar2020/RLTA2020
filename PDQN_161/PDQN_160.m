...
load('PDQN_161/Model_160/model_1220_1835.mat') %model_1220_1244
 seed = 0;
    rand('state', seed);
    % 加载环境信息，像素255表示障碍物情况
    Ob=imread('51.jpg');Ob=Ob(:,:,1);
...
%}
   ...
   % for e=109:E
    ...
    str=['PDQN_161/Data_',timestr{2},timestr{3},'_',timestr{4},timestr{5}];
    save([str,'.mat']);
    figure(6)
    imshow('51.jpg');
    hold on;
    ...
    plot(163,364,'c*','markersize',8);text(163,364+20,'中段初始点','FontSize',14,'color','r')
    plot(702,342,'c*','markersize',8);text(702,342+20,'再入点','FontSize',14,'color','r')
    text(327,317,'(拦截器区域)','FontSize',14,'color','r')
    title('红方飞行器的轨迹');
