function [ T, X, Y, Z, U, V, W ] = TSA_missile_TF( X0, Y0, Z0, m0, mf, Thmag0, theta, phi, Tburn )
...
%    [Th_x(n), Th_y(n), Th_z(n)] = TSA_thrust(T(n), Thmag0, theta, phi, Tburn, U(n), V(n), W(n)); 
   ...
   %添加二次推力
   [Th_x(n), Th_y(n), Th_z(n)] = TSA_double_thrust(T(n), Thmag0, theta, phi, Tburn, U(n), V(n), W(n));
